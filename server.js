...
// //get subjects and users
// app.get('/sau', async (req, res) => {
...
// // Define the route for assigning a subject to a student
...
// app.get('/getassign', handleGetassign);
// app.post('/addsubjecto', handleAddSubject);
// handleAddSubject
